...
import { imageBackgroundRemoverAi } from '@/ai/flows/image-background-remover-ai';
...
export default function ImageBackgroundRemoverTool() {
  ...
  const processFile = (file: File) => {
    ...
    reader.onload = async (e) => {
      ...
      setIsLoading(true);
      try {
        const result = await imageBackgroundRemoverAi({ photoDataUri: dataUri });
      ...
      <AnimatePresence>
        {originalImage && (
          ...
          >
            ...
            <div>
              <h3 className="text-center font-semibold mb-2">Processed Image</h3>
                ...
                {isLoading && (
                  <div className="absolute inset-0 flex items-center justify-center bg-black/50 z-10">
                    <div className="text-center text-white">
                      ...
                      <p className="text-sm">AI is removing the background.</p>
