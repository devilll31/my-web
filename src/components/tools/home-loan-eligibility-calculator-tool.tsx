...
export default function HomeLoanEligibilityCalculatorTool() {
  ...
  const guideProps = {
    title: "How to Use the Home Loan Eligibility Calculator",
    steps: [
      { title: "Enter Your Income", description: "Input your gross monthly income." },
      { title: "Provide Existing EMIs", description: "Add any other monthly loan payments you have." },
      { title: "Set Loan Details", description: "Define your desired loan tenure and the expected interest rate." }
    ],
    features: [
      { icon: SlidersHorizontal, title: "Interactive Dashboard", description: "Easily adjust values with sliders or manual input to see how they affect your loan eligibility in real-time." },
      { icon: BarChart, title: "Visual Breakdown", description: "The pie chart gives you a clear visual of your principal loan amount versus the total interest you'll pay over the tenure." },
      { icon: CheckCircle, title: "Informed Decisions", description: "Understand your borrowing capacity to make smarter financial decisions when looking for a home loan." }
    ]
  };
