        ...
        {originalFile && (
          ...
          >
            ...
            <div className="flex flex-col items-center p-4 border rounded-lg bg-muted/20">
                ...
                <p className="mt-2 text-sm font-semibold truncate">{convertedFile ? originalFile.name.replace(/\.pdf$/i, '.docx') : '...'}</p>
                <p className="text-xs text-muted-foreground">Converted Word</p>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
