          ...
          >
            ...
            >
              <div className="flex flex-col items-center justify-center text-primary">
                ...
                <p className="mt-4 text-muted-foreground">or drop Excel file here</p>
              </div>
            </div>
            <input
              type="file"
            ...
            />
             <div className="mt-8 text-center">
                <p className="text-muted-foreground max-w-2xl mx-auto">
                    Convert your Excel spreadsheets to PDF documents online for free. Maintain formatting and make your data easy to share and print.
                </p>
                <div className="mt-6 flex flex-wrap justify-center gap-x-8 gap-y-4">
                    <div className="flex items-center gap-2">
                        <CheckCircle className="w-5 h-5 text-green-500" />
                        <span className="font-medium">High-quality PDF conversion</span>
                    </div>
                     <div className="flex items-center gap-2">
                        <CheckCircle className="w-5 h-5 text-green-500" />
          ...
          >
            ...
            {!isLoading && convertedFile && (
               <div className="flex flex-col items-center justify-center p-12 bg-card rounded-2xl">
                  ...
                  <p className="font-semibold mt-4 text-lg bg-primary/10 text-primary px-4 py-2 rounded-lg">{originalFile.name.replace(/\.xlsx?$/i, '.pdf')}</p>
